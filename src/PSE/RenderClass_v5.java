...
public class RenderClass_v5 extends JPanel{
	...
	public RenderClass_v5(int W, int H){
		...
		visualizer = new AudioVisualizer(WIDTH, HEIGHT, 10, 6);
	}
...
//		}
	...
	public void paint(Graphics g) {
		...
		//draw gravitons (TODO get position of gravitons from the emitters)
...
//		}
	...
	private void drawBlockLighting() {
	...
	private void paintBlock(int x, int y) {
